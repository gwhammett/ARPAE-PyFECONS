...
\begin{table}[h]
    ...
    \begin{tabular}{lc}
    \hline
        Vessel volume (m$^3$) & 692\\
        Material & ASTM A240 304 SS\\
        Material mass (tons) & 715585\\
        Material cost (M USD) & 1.7\\
        Total cost (M USD) & 20 \\
         \hline
    \end{tabular}}
...
The costs for this subsystem are 20 M USD for the vacuum vessel, 768 M USD for the cooling systems, 7 M USD for the vacuum pumping systems, and 0.34 M USD for the roughing pump. The total cost is 795 M USD.\\
