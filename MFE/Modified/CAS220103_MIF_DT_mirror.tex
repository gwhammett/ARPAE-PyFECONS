...
\hline
Magnet Type & HTS CICC & HTS CICC & HTS CICC \\
Radius (m) & 3.8 & 0.18 & 0.67 \\
dr (m) & 0.25 & 0.2 & 0.3 \\
dz (m) & 0.35 & 6.3 & 0.6 \\
Current supply (MA) & 3.4 & 49.0 & 6.9 \\
Cable current density (A/mm$^2$) & jCable1 & jCable2 & jCable3 \\
Conductor current density (A/mm$^2$) & 150.0 & 150.0 & 150.0 \\
Cable width (m) & 0.014 & 0.014 & 0.014 \\
Cable height (m) & 0.017 & 0.017 & 0.017 \\
Total volume (m$^3$) & 2.1 & 1.4 & 0.76 \\
Cross-sectional area (m$^2$) & 0.087 & 1.3 & 0.18 \\
Turn-turn Insulation Fraction & 0.0 & 0.0  & 0.0  \\
\hline
Cable turns & 370.0 & 5300.0 & 760.0 \\
Total turns of conductor & 43000.0 & 620000.0 & 89000.0 \\
Length of conductor (km) & 1000.0 & 700.0 & 370.0 \\
Current per conductor (A) & 78.0 & 78.0 & 78.0 \\
\hline
Cost of SC (M USD) & 4.0 & 2.7 & 1.5 \\
Cost of copper (M USD) & 0.052 & 0.036 & 0.019 \\
